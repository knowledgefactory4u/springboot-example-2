						...
						<div class="col-md-12">
							...
							<div class="card card-primary">
								<div class="card-header">
									<h3 class="card-title">MD5 Encryption</h3>
								</div>
								<!-- /.card-header -->
								<!-- form start -->
								<form role="form">
									<div class="card-body">
										<div class="form-group">
											<label>Enter a word here to get its MD5 hash :</label>
											<textarea id="encmd5" class="form-control" rows="6"
									...
									<div class="card-footer">
										<button id="encryptclickedmd5" type="submit"
											class="btn btn-primary">Crypt</button>
									</div>

									<div class="form-group">
										<label>The MD5 hash is:</label>
										<textarea id="cryptoutmd5" class="form-control" rows="6"
